import { CITIES, cop, NOT_INCLUDED, REGION } from "./data";
...
export const FAQ: { q: string; a: string }[] = [
  ...
  {
    q: "¿Qué incluye la tarifa mensual?",
    a:
      "Póliza todo riesgo, mantenimiento preventivo y correctivo por desgaste normal, GPS satelital, SOAT, " +
      `revisión técnico-mecánica e impuestos. Corren por tu cuenta: ${list(NOT_INCLUDED).toLowerCase()}.`,
  },
  {
  ...
  {
    q: "¿Me entregan los documentos para inscribir la camioneta con mi contratante?",
    a: "Sí. Con cada unidad entregamos copia del SOAT, la revisión técnico-mecánica y la póliza vigentes.",
  },
  {
